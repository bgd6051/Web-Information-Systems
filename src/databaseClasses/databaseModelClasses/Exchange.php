...
class Exchange
{
    ...
    public function __construct(
        ...
        ?string $Image = null,
        ?int $TrustScore = null,
        ?float $TradeVolume24hBtc = null,
        ?int $ID_EXCHANGE = null
    ) {
        $this->Id = $Id;
        $this->Name = $Name;
    ...
    public static function constructExchangeArray(array $responseArray): array
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            $exchange = new Exchange(
                $exchangeLine["id"],
                $exchangeLine["name"],
                $exchangeLine["year_established"],
                $exchangeLine["country"],
                $exchangeLine["image"],
                $exchangeLine["trust_score"],
    ...
    public function toHTML(): string
    {
        ...
        return "<li>" . $this->Id . $separador . $this->Name . $separador .
            ...
            $this->TrustScore . $separador . round($this->TradeVolume24hBtc, 2) . "</li>";
    }
}