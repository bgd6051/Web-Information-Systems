...
class DBInsertor extends DBHandler {
    ...
    public function insertAdminLog($adminLog) {
        ...
        return $this->executeQuery($query, ["ss", $adminLog->getID_ADMIN(), $adminLog->getAction(), $adminLog->getFecha()]);
    }
    public function insertExchangeRate($exchangeRate) {
        ...
        return $this->executeQuery($query, ["ss", $exchangeRate->getID_COIN_FORM(), $exchangeRate->getID_COIN_TO(), $exchangeRate->getDate(), $exchangeRate->getPrice()]);
    }
    ...
    public function insertTrendingCoin($trendingCoin) {
        ...
        return $this->executeQuery($query, ["ss", $trendingCoin->getID_COIN(), $trendingCoin->getDate()]);
    }
    public function insertUserRegistration($userRegistration) {
        ...
        return $this->executeQuery($query, ["ss", $userRegistration->getUsername(), $userRegistration->getPassword(), $userRegistration->getRole()]);
    }
}