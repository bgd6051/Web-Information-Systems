...
<link rel="icon" type="image/png" href="./icons/Bitcoin.svg.webp">
    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <nav class="nav-collapse">
          <ul>                                                                                
          	<li class="menu-item active"><a href="#banner" data-scroll>SERVICES</a></li>
            <li class="menu-item"><a href="#hows" data-scroll>HOW</a></li>
